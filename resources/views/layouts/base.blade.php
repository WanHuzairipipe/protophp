    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/dashboards/default.html" target="_blank">
                <img src="../../assets/img/jata-logo.png" class="navbar-brand-img h-100" alt="main_logo">
                <span class="ms-1 font-weight-bold">Ketsa - Access System</span>
            </a>
        </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse " id="pagesExamples">
                        <ul class="nav ms-4 ps-3">
                            <li class="nav-item ">
                                <a class="nav-link " href="../applications/permit">
                                    <span class="sidenav-mini-icon"> P </span>
                                    <span class="sidenav-normal"> Permit Review </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link " href="/applications/payment">
                                    <span class="sidenav-mini-icon"> C </span>
                                    <span class="sidenav-normal"> Check Payment </span>
                                </a>
                            </li>
                        </ul>
                    </div>
